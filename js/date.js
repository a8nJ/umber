...
export function f_date(s_id) {
   ...
   const o = new Date(n_id * 1000);
   const s_day = o.toLocaleString(0, {weekday: 'short'});
   const s_mon = o.toLocaleString(0, {month: 'short', day: 'numeric'});
   const s_year = o.toLocaleString(0, {year: 'numeric'});
